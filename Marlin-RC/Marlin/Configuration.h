...
#define CUSTOM_MACHINE_NAME "Harsla MC"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,4000, 98}  //98 default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {300, 300, 2, 25}    // 300 300 5 25 (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {3000,3000,10,10000}    //4000 4000 10 10000// X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.

#define DEFAULT_ACCELERATION          1000    // 3000 X, Y, Z and E acceleration in mm/s^2 for printing moves
#define DEFAULT_RETRACT_ACCELERATION  3000    // E acceleration in mm/s^2 for retracts
#define DEFAULT_TRAVEL_ACCELERATION   3000    // X, Y, Z acceleration in mm/s^2 for travel (non printing) moves

// The speed change that does not require acceleration (i.e. the software might assume it can be done instantaneously)
#define DEFAULT_XYJERK                6.0    //20.0    // (mm/sec)
